...
func NewErr(reason interface{}, cause ...error) Err {
	var err Err
	err.reason = reason
...
func (err Err) Get(name string) interface{} {
	if err.reason == nil {
		return nil
	}
...
func (err Err) Situation() map[string]interface{} {
